...
sc_input_manager_process_key(struct sc_input_manager *im,
    ...
    // ==========================================
    // KEYMAPPER SHORTCUTS & INPUT HANDLING
    // ==========================================
    ...
    if (kms->edit_mode && down && sdl_keycode == SDLK_DELETE && kms->selected >= 0) {
    ...
    // KEYMAPPER: intercept mapped keys
...
sc_input_manager_process_mouse_button(struct sc_input_manager *im,
    ...
    if (kms->edit_mode) {
        SDL_Event ev;
        ev.type = (event->type == SDL_EVENT_MOUSE_BUTTON_DOWN) ? SDL_EVENT_MOUSE_BUTTON_DOWN
