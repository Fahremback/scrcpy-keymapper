...
struct km_state {
    ...
    SDL_Window *window;   // active window reference for mouse capture
};
...
void
km_render_overlay(SDL_Renderer *renderer, const struct SDL_FRect *content_rect,
...
bool
km_handle_edit_mouse(const SDL_Event *event, const struct SDL_FRect *content_rect,
                     struct sc_size frame_size);
